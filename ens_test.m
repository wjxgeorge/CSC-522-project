...
parfor m=1:lo
    for n=1:la
        if (~no_detect(m, n))
            ...
            ensmd = fitcensemble(train_data, train_labels, 'Method', 'AdaBoostM2','Cost', cur_cost_matrix, 'CrossVal', 'off');
            ensmd.ScoreTransform = 'doublelogit'
            ...
            [predictl,postp] = predict(ensmd, testd);
